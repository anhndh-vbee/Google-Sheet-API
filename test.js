...
// Create a new array newArr with updated task fields
const newArr = arr1.map((item, index) => ({
  ...item,
  task: arr2[index].map((subtask) => ({ ...subtask })),
}));

fs.writeFile("./demo", JSON.stringify(newArr), function (err) {
  if (err) {
